...
internal class Object
{
    ...
    {
        orig(self);
        if (self.type == Register.SpikePlant)
            self.realizedObject = new SpikePlant(self, self.world); //Like any physical object, your object will take an abstract object as a parameter. This will be written in more detail later
    }
    ...
    private static void Room_Loaded(On.Room.orig_Loaded orig, Room self)
    {
        ...
        for (int num20 = 0; num20 < self.roomSettings.placedObjects.Count; num20++)
        {
            ...
            if (self.roomSettings.placedObjects[num20].type == Register.SpikePlant_PO)
            {
    ...
    {
        orig(self);
        if (self.type == Register.SpikePlant_PO) //The registered name of your PlacedObject.Type
    ...
    {
        if (owner.type == Register.SpikePlant_PO)
        {
            self.minRegen = 1;
            self.maxRegen = 7;
        }
    ...
    {
        if (type == Register.SpikePlant_PO)
